...
export default function FAQ() {
  return (
    <section className="border-t border-white/5 bg-black px-6 py-10 sm:py-22 md:py-26 lg:px-10 lg:py-30">
...
function FAQItem({ question, answer }: FAQItemProps) {
  ...
  return (
    <div
      className="bg-background group cursor-pointer border border-white/5 px-0 py-8 sm:py-10 md:px-10"
